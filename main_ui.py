...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QLabel, 
                             ...
                             QTextEdit, QFileDialog, QGroupBox, QToolBox)
...
class RiverArchitectWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Vertical navigation using QToolBox
        ...
        condition_layout.addLayout(content_layout)
        ...
        self.toolbox.addItem(condition_tab, "Condition")
        self.toolbox.addItem(QWidget(), "Lifespan")
        self.toolbox.addItem(QWidget(), "Ecorhydraulic")
